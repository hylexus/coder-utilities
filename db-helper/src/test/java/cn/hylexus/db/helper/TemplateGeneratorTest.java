...
public class TemplateGeneratorTest {
	...
	private TemplateGenerator generator = null;
	{
		...
		try {
			List<String> tableList = Arrays.asList("t_user");
			DBHelperContext context = new DBHelperContext().connection(getConnection()).config(new DBHelperConfig().tableList(tableList));
